...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">9</div><div class="do">10</div><div class="no">11</div><div class="no">12</div>
        ...
        <p class="question"><strong>Everyone says that Kathy (&emsp;&emsp;&emsp;) her mother. They have the same large eyes and smile in the same way.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. instructs</button>
            <button type="button" id="false2" class="answer">2. bothers</button>
            <button type="button" id="false3" class="answer">3. seeks</button>
            <button type="button" id="true" class="answer">4. resembles</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index11.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ねずこ.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index11.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/無惨.jpg";
