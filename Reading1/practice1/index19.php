...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">17</div><div class="no">18</div><div class="do">19</div><div class="no">20</div>
        </div>
        <p class="question"><strong>A : Have you read that book I lend you?<br>B : I’m still reading it, but I (&emsp;&emsp;&emsp;) it by tomorrow morning. I’ll give it back to you then.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. will have finished</button>
            <button type="button" id="false1" class="answer">2. had finished</button>
            <button type="button" id="false2" class="answer">3. would be finished</button>
            <button type="button" id="false3" class="answer">4. was finishing</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index20.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/イチロー.jpg";
            ...
            function false_click(){
                ...
                next_page.href = "./index20.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/野球痛い.jpg";
