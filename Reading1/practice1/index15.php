...
<html lang="ja">
    ...
    <body>
        ...
        <p class="question"><strong>Sam studied for his math test every evening last weekend. His hard work (&emsp;&emsp;&emsp;) a very good score on the test.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. looked up</button>
            <button type="button" id="true" class="answer">2. resulted in</button>
            <button type="button" id="false2" class="answer">3. dropped by</button>
            <button type="button" id="false3" class="answer">4. turned off</button>
