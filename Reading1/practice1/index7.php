...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">5</div><div class="no">6</div><div class="do">7</div><div class="no">8</div>
        ...
        <p class="question"><strong>Ms. Kirshman was surprised at the large number of people who (&emsp;&emsp;&emsp;) her lecture on gardening. There were almost no empty seats in the room.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. sailed</button>
            <button type="button" id="true" class="answer">2. attended</button>
            <button type="button" id="false2" class="answer">3. guarded</button>
            <button type="button" id="false3" class="answer">4. failed</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index8.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ゾロ.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index8.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ミホーク.gif";
