...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">9</div><div class="no">10</div><div class="do">11</div><div class="no">12</div>
        ...
        <p class="question"><strong>A : Hello, Jane. Where are you? The movie will start soon.<br>B : Sorry, I’ll be there before (&emsp;&emsp;&emsp;). Please wait for me for five more minutes.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. long</button>
            <button type="button" id="false1" class="answer">2. little</button>
            <button type="button" id="false2" class="answer">3. less</button>
            <button type="button" id="false3" class="answer">4. late</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index12.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ドラえもん.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index12.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/怒る人.png";
