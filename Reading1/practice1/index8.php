...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">5</div><div class="no">6</div><div class="no">7</div><div class="do">8</div>
        ...
        <p class="question"><strong>A : Brad, what (&emsp;&emsp;&emsp;) of music do you usually listen to?<br>B : I like hip-hop, but I also listen to jazz.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. position</button>
            <button type="button" id="false2" class="answer">2. price</button>
            <button type="button" id="true" class="answer">3. sort</button>
            <button type="button" id="false3" class="answer">4. shape</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index9.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/チョッパー.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index9.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/villain6.png";
