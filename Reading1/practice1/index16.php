...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">13</div><div class="no">14</div><div class="no">15</div><div class="do">16</div>
            <div class="no">17</div><div class="no">18</div><div class="no">19</div><div class="no">20</div>
        </div>
        <p class="question"><strong>Helen took someone else’s jacket (&emsp;&emsp;&emsp;) when she left school. She went back later to return it.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. for sure</button>
            <button type="button" id="false2" class="answer">2. in part</button>
            <button type="button" id="false3" class="answer">3. at heart</button>
            <button type="button" id="true" class="answer">4. by mistake</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index17.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/アイアンマン.jpg";
            ...
            function false_click(){
                ...
                next_page.href = "./index17.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/サノス.png";
