...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">17</div><div class="no">18</div><div class="no">19</div><div class="do">20</div>
        </div>
        <p class="question"><strong>Emily has three children and works every day, so she is very busy. She likes to watch TV (&emsp;&emsp;&emsp;) she has a chance to relax.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. wherever</button>
            <button type="button" id="false1" class="answer">2. whichever</button>
            <button type="button" id="false2" class="answer">3. whoever</button>
            <button type="button" id="false3" class="answer">4. whatever</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./check.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ヒカキン.jpg";
            ...
            function false_click(){
                ...
                next_page.href = "./check.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ヒカキン悔しい.jpg";
