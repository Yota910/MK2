...
<html lang="ja">
    ...
    <body>
        <div class="area">
            <div class="no">1</div><div class="do">2</div><div class="no">3</div><div class="no">4</div>
        ...
        <p class="question"><strong>Last Saturday, Pete and his family drove to the beach. In order to avoid the heavy (&emsp;&emsp;&emsp;) on the highway, they left early in the morning.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. traffic</button>
            <button type="button" id="false1" class="answer">2. pride</button>
            <button type="button" id="false2" class="answer">3. rhythm</button>
            <button type="button" id="false3" class="answer">4. temple</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index3.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ナルト.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index3.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/villain2.png";
