...
<html lang="ja">
    ...
    <body>
        ...
        <p class="question"><strong>Because William was gaining a lot of weight, his doctor (&emsp;&emsp;&emsp;) him to start exercising and to eat healthier food.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. stretched</button>
            <button type="button" id="false2" class="answer">2. planted</button>
            <button type="button" id="false3" class="answer">3. trusted</button>
            <button type="button" id="true" class="answer">4. advised</button>
