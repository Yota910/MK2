...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="do">9</div><div class="no">10</div><div class="no">11</div><div class="no">12</div>
        ...
        <p class="question"><strong>The street outside Lisa’s apartment building is very (&emsp;&emsp;&emsp;). It is only wide enough for one car, and trucks cannot enter at all.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. balanced</button>
            <button type="button" id="false2" class="answer">2. careful</button>
            <button type="button" id="true" class="answer">3. narrow</button>
            <button type="button" id="false3" class="answer">4. suitable</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index10.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/サスケ.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index10.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/マダラ.png";
