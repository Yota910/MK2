...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="do">17</div><div class="no">18</div><div class="no">19</div><div class="no">20</div>
        </div>
        <p class="question"><strong>Reiko told her parents that she would call them as soon as she got to Vancouver, but she did not keep her (&emsp;&emsp;&emsp;). Her parents were worried about her.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. mind</button>
            <button type="button" id="false2" class="answer">2. place</button>
            <button type="button" id="true" class="answer">3. promise</button>
            <button type="button" id="false3" class="answer">4. sight</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index18.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/スパイダーマン.jpg";
            ...
            function false_click(){
                ...
                next_page.href = "./index18.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ヴェノム.png";
