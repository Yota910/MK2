...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">13</div><div class="do">14</div><div class="no">15</div><div class="no">16</div>
            <div class="no">17</div><div class="no">18</div><div class="no">19</div><div class="no">20</div>
        </div>
        <p class="question"><strong>A : Let’s have a barbecue in the park.<br>B : No, that would be (&emsp;&emsp;&emsp;) the park’s rules. We can have one in our backyard, though.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. behind</button>
            <button type="button" id="true" class="answer">2. against</button>
            <button type="button" id="false2" class="answer">3. under</button>
            <button type="button" id="false3" class="answer">4. with</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index15.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ハイジ.jpg";
            ...
            function false_click(){
                ...
                next_page.href = "./index15.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ヤギ.png";
