...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="no">5</div><div class="do">6</div><div class="no">7</div><div class="no">8</div>
        ...
        <p class="question"><strong>Mike has lived in Seattle for two years. He enjoys living there, but he does not like the cool, rainy (&emsp;&emsp;&emsp;).</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. climate</button>
            <button type="button" id="false1" class="answer">2. surface</button>
            <button type="button" id="false2" class="answer">3. excuse</button>
            <button type="button" id="false3" class="answer">4. design</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index7.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ゴン.gif";
            ...
            function false_click(){
                ...
                next_page.href = "./index7.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/ヒソカ.gif";
