...
<html lang="ja">
    ...
    <body>
        <div class="area">
            <div class="no">1</div><div class="no">2</div><div class="do">3</div><div class="no">4</div>
        ...
        <p class="question"><strong>A : I left my notebook somewhere. Do you have a (&emsp;&emsp;&emsp;) of paper I could use to take notes?<br>B : Yes. Here you are.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. board</button>
            <button type="button" id="false2" class="answer">2. flash</button>
            <button type="button" id="true" class="answer">3. sheet</button>
            <button type="button" id="false3" class="answer">4. part</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index4.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/炭治郎.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index4.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/villain3.jpg";
