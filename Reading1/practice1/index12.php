...
<html lang="ja">
    ...
    <body>
        ...
        <p class="question"><strong>Mark started playing a new video game. It was really exciting, so he played it all (&emsp;&emsp;&emsp;) the night. The next day, he was really tired.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. across</button>
            <button type="button" id="false2" class="answer">2. on</button>
            <button type="button" id="false3" class="answer">3. down</button>
            <button type="button" id="true" class="answer">4. through</button>
