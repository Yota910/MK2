...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="do">5</div><div class="no">6</div><div class="no">7</div><div class="no">8</div>
        ...
        <p class="question"><strong>The teacher told the students to (&emsp;&emsp;&emsp;) their chairs in a circle so that they would all be able to see each other while they talked.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. arrange</button>
            <button type="button" id="false1" class="answer">2. block</button>
            <button type="button" id="false2" class="answer">3. skip</button>
            <button type="button" id="false3" class="answer">4. offer</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index6.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/悟空.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index6.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/villain5.png";
