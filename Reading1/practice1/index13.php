...
<html lang="ja">
    ...
    <body>
        <div class="area">
            ...
            <div class="do">13</div><div class="no">14</div><div class="no">15</div><div class="no">16</div>
            <div class="no">17</div><div class="no">18</div><div class="no">19</div><div class="no">20</div>
        </div>
        <p class="question"><strong>James asked his father to lend him the money to go on a trip with his friends. His father said it was (&emsp;&emsp;&emsp;) the question and told James to get a part-time job instead.</strong></p>
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. expect for</button>
            <button type="button" id="true" class="answer">2. out of</button>
            <button type="button" id="false2" class="answer">3. all about</button>
            <button type="button" id="false3" class="answer">4. next to</button>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("true").onclick = function() {
                ...
                next_page.href = "./index14.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/キキ.png";
            ...
            function false_click(){
                ...
                next_page.href = "./index14.php"
                next_page.textContent = '次へ';
                document.getElementById("image_place").src = "../../picture/キキ熱.jpg";
