...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. Buy movie tickets.</button><br>
            <button type="button" id="true" class="answer">2. Send someone to fix the TV.</button><br>
            <button type="button" id="false2" class="answer">3. Find a different hotel.</button><br>
            <button type="button" id="false3" class="answer">4. Help her check in.</button>
