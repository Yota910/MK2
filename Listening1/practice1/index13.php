...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. She wants him to buy his own.</button><br>
            <button type="button" id="true" class="answer">2. She wants him to keep playing soccer.</button><br>
            <button type="button" id="false2" class="answer">3. She thinks he needs a new pair of soccer shoes.</button><br>
            <button type="button" id="false3" class="answer">4. She thinks he should use his old one.</button>
