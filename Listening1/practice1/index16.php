...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. Get his camera fixed.</button><br>
            <button type="button" id="true" class="answer">2. Show the woman a letter.</button><br>
            <button type="button" id="false2" class="answer">3. Meet the gallery's director.</button><br>
            <button type="button" id="false3" class="answer">4. Buy a copy of Art Today magazine.</button>
