...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. She does no like her teacher.</button><br>
            <button type="button" id="true" class="answer">2. She cannot take the Tuesday class.</button><br>
            <button type="button" id="false2" class="answer">3. She cannot find the language school.</button><br>
            <button type="button" id="false3" class="answer">4. She has forgotten how to speak Italian.</button>
