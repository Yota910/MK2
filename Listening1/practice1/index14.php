...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. He found a useful website.</button><br>
            <button type="button" id="false2" class="answer">2. He called the library for help.</button><br>
            <button type="button" id="false3" class="answer">3. He borrowed some new magazines.</button><br>
            <button type="button" id="true" class="answer">4. He used some old books.</button>
