...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="true" class="answer">1. Eat at a nearby restaurant.</button><br>
            <button type="button" id="false1" class="answer">2. Attend their meeting together.</button><br>
            <button type="button" id="false2" class="answer">3. Have lunch at 1:30.</button><br>
            <button type="button" id="false3" class="answer">4. Call their office.</button>
