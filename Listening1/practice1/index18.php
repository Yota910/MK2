...
<html lang="ja">
    ...
    <body>
        ...
        <div id="select_button" class="select">
            <button type="button" id="false1" class="answer">1. She has never cooked before.</button><br>
            <button type="button" id="false2" class="answer">2. She does not like spaghetti.</button><br>
            <button type="button" id="true" class="answer">3. She is learning how to cook.</button><br>
            <button type="button" id="false3" class="answer">4. She is writing a cookbook.</button>
